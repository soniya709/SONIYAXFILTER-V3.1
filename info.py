...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/shareus_open_tutorial/8') # How to open tutorial link for verification

# Others
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.shareus.io')
SHORTLINK_API = environ.get('SHORTLINK_API', '3jYRIxHEl9b0AgGd5cauMww08mO2')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ps_discuss')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ps_updates')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/shareus_open_tutorial/8') # Tutorial video link for opening shortlink website 
...
PAYMENT_ADMIN_USERNAME = environ.get("PAYMENT_ADMIN_USERNAME", "pssupport_Robot")
